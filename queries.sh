...
echo "$($PSQL "SELECT DISTINCT games.year, t1.name AS winner_team FROM games JOIN teams t1 on games.winner_id = t1.team_id WHERE games.round = 'Final' ORDER BY games.year")"
